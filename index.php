    ...
    <div class="container-fluid marketing">
      ...
      <div class="row featurette">
        ...
        <div class="col-xs-12 col-md-7">
		  ...
		  <p class="lead">Share with your friends, classmates and community and invite them to join you in the positive steps you’re taking to make the world a better place.</p>
        </div>
      </div><!-- /.row -->
		...
		<div class="col-md-1"></div>
		  ...
		  <div class="col-xs-6 col-md-6">
			...
			<form class="form-horizontal">  
				...
				<div class="form-group">
					<button type="button" class="btn btn-primary" href="#">Sign Me Up!</button>
